...
\usepackage[latin1]{inputenc}%          %% input encoder für umlaute usw.
...
%% include appendix
\begin{appendix}
\printglossary[type=\acronymtype, title=Glossar, toctitle=Glossar]
\end{appendix}
