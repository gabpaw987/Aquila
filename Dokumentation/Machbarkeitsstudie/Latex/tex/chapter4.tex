...
* CGI (Ausführung über CommandLine)
* Streams/Sockets
* Datenbank (Problem: Pull-Ansatz)
* WebServices
* WCF

* Entgültige Wahl der Websprache (ASP.NET)